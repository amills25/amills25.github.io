                ...
                <div className="container">
                    ...
                    > */}
                        <nav className="nav nav-item nav-pills nav-fill">
                            <NavLink className="nav-link fw-bold bg-white text-black" to="/home">Home</NavLink>
                            <NavLink className="nav-link fw-bold bg-white text-black" to="/about">About</NavLink>
                            <NavLink className="nav-link fw-bold bg-white text-black" to="/blog">Blog</NavLink>
                            <NavLink className="nav-link fw-bold bg-white text-black" to="/projects">Portfolio</NavLink>
                            <NavLink className="nav-link fw-bold bg-white text-black" to="/contact">Contact Me</NavLink>
                        </nav>
                    {/* </div> */}
                </div>
